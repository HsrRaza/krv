...
export default function HomePage() {
  ...
  const [activeGalleryModal, setActiveGalleryModal] =
  ...
  const inProgressProjects = dbProjects.filter(
    (p) => p.status === "in_progress"
  );

  // Gallery projects are only completed records created for the showcase.
  const galleryProjects = dbProjects.filter(
  ...
  const getGalleryCategory = (category: string) => {
    ...
    if (
      normalizedCategory.includes("elevation") ||
    ...
    ...Array.from(
      new Set(
        galleryProjects.map((project) =>
          getGalleryCategory(project.category)
        )
      )
    ),
  ];
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    const targetUrl = `https://wa.me/918123758878?text=${encodeURIComponent(
      messageText
    )}`;
    ...
    <div className="space-y-24 pb-20 overflow-hidden bg-[#f4f1eb] text-slate-900">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center pt-2 sm:pt-4">
          ...
          >
            ...
            <p className="font-sans font-normal text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl">
              KRV Builders & Developers is Ramanagara&apos;s premier civil
              construction firm. From Vastu-aligned blueprints and 3D
              elevations to turnkey RCC residential and commercial structures.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-200/80 w-full max-w-lg">
              <div>
                <div className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-slate-900">
                  150+
                </div>
                <div className="font-sans text-xs text-slate-600 font-semibold mt-0.5">
                  Projects Delivered
                </div>
              </div>

              <div>
                <div className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-amber-600">
                  100%
                </div>
                <div className="font-sans text-xs text-slate-600 font-semibold mt-0.5">
                  Vastu Compliant
          ...
          >
            {inProgressProjects.length > 0 || dbProjects.length > 0
              ? (() => {
                const activeProject =
                  inProgressProjects[0] || dbProjects[0];
                ...
                return (
                  <div className="p-7 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-xl border border-slate-200/90 shadow-2xl space-y-5 text-slate-900 transition-all">
                    <div className="flex items-center justify-between">
                      <span
                        className={`font-display font-bold text-xs uppercase tracking-architectural px-3 py-1 rounded-full border ${isInProgress
                    ...
                    <div className="relative h-52 sm:h-56 rounded-2xl overflow-hidden border border-slate-200 shadow-md bg-slate-900 group">
                      <img
                        src={getMediaUrl(activeProject.cover_image)}
                    ...
                    <Link
                      href={
                        isInProgress ? "/work-in-progress" : "/gallery"
                      }
                    ...
                    >
                      <span>
                        {isInProgress
                          ? "View All Work In Progress Sites"
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="font-sans font-normal text-sm sm:text-base text-slate-600 leading-relaxed">
            From initial site measurement to final keys handover, we manage
            every phase with engineering precision.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 relative z-10">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-2 max-w-xl">
                Explore our ongoing construction sites across Ramanagara. We
                maintain transparent reporting with live photo updates.
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="p-5 space-y-2">
                    ...
                    <p className="text-xs text-slate-300 line-clamp-2">
                      {project.description ||
                        "Active construction site supervised by KRV engineers."}
                    </p>
                  </div>
                </div>
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          ...
          <p className="text-slate-600 text-sm font-normal">
            Browse our masonry portfolio featuring residential villas,
            commercial facades, and 3D Vastu models.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-10">
          {galleryCategories.map((cat) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold transition duration-200 ${selectedCategory === cat
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4">
          {filteredGalleryProjects.map((project) => (
            <div
              key={project.id}
              onClick={() =>
                setActiveLightboxUrl(project.cover_image)
              }
            ...
            >
              {project.cover_image ? (
                ...
                <div className="flex min-h-48 items-center justify-center bg-slate-100 text-sm text-slate-500">
                  No cover image
                </div>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
                14+ years of unblemished trust in Ramanagara with over 150+
                completed structural projects and satisfied homeowners.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
                In-house team of licensed civil engineers, 3D visualizers,
                and skilled workforce capable of handling simultaneous job
                sites.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
                Proven record across luxury residential villas, multi-family
                duplexes, commercial retail spaces, and interior fit-outs.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
                Transparent stage-by-stage billing, zero hidden costs, and
                guaranteed on-time completion timelines.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div>
              ...
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
                Drop by our office or call our senior engineers directly for
                site visits and Vastu planning.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-600 leading-relaxed mt-1 font-medium">
                  1st Floor, Above Canara Bank ATM, Moti Nagar Extension,
          ...
          <div className="lg:col-span-7">
            <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200/90 shadow-md">
              <h3 className="text-2xl font-bold text-slate-900">
                Enquire / Book Consultation
              </h3>

              <p className="text-xs text-slate-500 mt-1 mb-6">
                Fill in your project details below and submit to open an
                encoded chat with our engineering lead.
              </p>
              ...
              <form onSubmit={handleContactSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-stone-50 border border-slate-200 text-sm text-slate-900 focus:outline-none focus:border-amber-600 focus:bg-white"
                    >
                      <option value="Architectural Planning with Vastu">
                        Architectural Planning with Vastu
                      </option>
                      <option value="Building Construction">
                        Turnkey Building Construction
                      </option>
                      <option value="Structural Engineering">
                        Structural Engineering & RCC
                      </option>
                      <option value="3D Elevation">
                        Photorealistic 3D Elevation
                      </option>
                      <option value="Interior Design">
                        Interior Design
                      </option>
                      <option value="Estimation & Costing">
                        Estimation & Costing
                      </option>
                    </select>
                  </div>
                ...
                >
                  <MessageSquare className="w-4 h-4 fill-white/20" />
                  <span>
                    Send Enquiry via WhatsApp (+91 8123758878)
                  </span>
                </button>
              </form>
            </div>
            ...
            <div className="p-6 border-b border-slate-800 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-amber-400 mt-0.5">
                  Live Site Photos • Phase:{" "}
                  {activeGalleryModal.current_phase || "In Progress"}
                </p>
              </div>
                ...
                {[
                  ...
                  .map((objectKey, idx) => (
                    <div
                      key={`${objectKey}-${idx}`}
                      onClick={() =>
                        setActiveLightboxUrl(objectKey)
                      }
      ...
      {activeLightboxUrl && (
        ...
        >
          ...
          >
            <img
              src={getMediaUrl(activeLightboxUrl)}
              alt="Expanded view"
